...
export class ProductoController {
  ...
  static async transladoProductos (req, res) {
    try {
      const { id, id_producto, id_bodega_origen, id_bodega_destino, cantidad } = req.body
      ...
      const translado = { id, id_producto, id_bodega_origen, id_bodega_destino, cantidad }
      const result = await ProductoModel.transladoProductos({ object: translado })
